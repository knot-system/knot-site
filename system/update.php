...
$api_url = 'https://api.github.com/repos/knot-system/knot-site/releases';
$dev_zip = 'https://github.com/knot-system/knot-site/archive/refs/heads/main.zip';
...
if( $step == 'check' ) {
	...
	if( empty($_REQUEST['version']) || $_REQUEST['version'] == 'latest' ) {
		...
		$zip_folder_name_start = 'knot-system-knot-site-';
