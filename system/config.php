...
return [
	...
	'token_endpoint' => 'https://tokens.indieauth.com/token', // NOTE: this will change soon; TODO: set to false, and set own auth module while installing in the user config
