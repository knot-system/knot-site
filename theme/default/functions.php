...
add_metatag( 'generator', '<meta tag="generator" content="Eigenheim v.'.$core->version().' with '.$core->theme->get('name').' v.'.$core->theme->get('version').'">' );


// add favicon
add_metatag( 'favicon', '<link rel="icon" href="data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%2210 0 100 100%22><text y=%22.90em%22 font-size=%2290%22>🏡</text></svg>">' );
